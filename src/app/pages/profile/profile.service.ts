...
export class ProfileService {
  ...
  updateName(Nombre: string): Observable<DocumentReference<DocumentData>> {
    return this.getUserProfileReference().pipe(
      tap({
        next: userProfileReference => setDoc(userProfileReference, { Nombre }, { merge: true }),
  ...
  updateApellido(Apellido: string): Observable<DocumentReference<DocumentData>> {
    return this.getUserProfileReference().pipe(
      tap({
        next: userProfileReference => setDoc(userProfileReference, { Apellido }, { merge: true }),
        error: error => console.error(error),
      }),
      catchError(() => EMPTY)
    );
  ...
  updateDNI(DNI: number): Observable<DocumentReference<DocumentData>> {
    return this.getUserProfileReference().pipe(
      tap({
        next: userProfileReference => setDoc(userProfileReference, { DNI }, { merge: true }),
        error: error => console.error(error),
      }),
      catchError(() => EMPTY)
    );
  ...
  updateNacionalidad(Nacionalidad: string): Observable<DocumentReference<DocumentData>> {
    return this.getUserProfileReference().pipe(
      tap({
        next: userProfileReference => setDoc(userProfileReference, { Nacionalidad }, { merge: true }),
        error: error => console.error(error),
      }),
      catchError(() => EMPTY)
    );
  ...
  updateNacimiento(Fecha_Nacimiento: string): Observable<DocumentReference<DocumentData>> {
    return this.getUserProfileReference().pipe(
      tap({
        next: userProfileReference => setDoc(userProfileReference, { Fecha_Nacimiento }, { merge: true }),
        error: error => console.error(error),
      }),
      catchError(() => EMPTY)
    );
  ...
  updateSexo(Sexo: string): Observable<DocumentReference<DocumentData>> {
    return this.getUserProfileReference().pipe(
      tap({
        next: userProfileReference => setDoc(userProfileReference, { Sexo }, { merge: true }),
        error: error => console.error(error),
      }),
      catchError(() => EMPTY)
    );
